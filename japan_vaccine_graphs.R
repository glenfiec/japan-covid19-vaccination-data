...
vaccine_graph <- ggplot(reshaped, aes(x = Date, y = value, fill = variable)) + 
  ...
  scale_y_continuous(name = "Total daily doses given", label = comma, limits = c(0, 1000000)) + 
